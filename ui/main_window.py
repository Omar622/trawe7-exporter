...
class MainWindow(tb.Window):
    ...
    def build_ui(self):
        ...
        current_fonts = self.fonts[self.lang]
        self.style.configure('TLabel', background='#181c1f', foreground='#fff', font=current_fonts['main'])
        self.style.configure('TButton', font=current_fonts['main'], borderwidth=0, focusthickness=3, focuscolor='none')
        self.style.configure('Accent.TButton', font=current_fonts['bold'], borderwidth=0, focusthickness=3, focuscolor='none', background='#c9b37c', foreground='#222')
        self.style.configure('Success.TButton', font=current_fonts['bold'], borderwidth=0, focusthickness=3, focuscolor='none', background='#1fa463', foreground='#fff')
        self.style.configure('Danger.TButton', font=current_fonts['bold'], borderwidth=0, focusthickness=3, focuscolor='none', background='#333', foreground='#fff')

        # --- Header ---
        header_frame = tb.Frame(self, bootstyle="dark")
        header_frame.pack(fill=tk.X, pady=(0, 2))
        self.title_label = tb.Label(header_frame, text=self.lang_dict[self.lang]['app_title'], font=current_fonts['title'], bootstyle="inverse-dark")
        ...
        self.files_listbox = tk.Listbox(files_frame, height=3, bg="#23272b", fg="#fff", selectbackground="#c9b37c", selectforeground="#222", font=current_fonts['main'], relief=tk.FLAT, highlightthickness=0, borderwidth=0)
        self.files_listbox.pack(fill=tk.BOTH, expand=True)
        for f in ["surah1.mp3", "surah2.wav", "surah3.mp3"]:
        ...
        self.audio_time = tb.Label(audio_frame, text='02:15 / 45:00', font=current_fonts['main'], bootstyle="inverse-dark")
        ...
        self.cuts_listbox = tk.Listbox(rec_frame, height=5, bg="#23272b", fg="#fff", selectbackground="#c9b37c", selectforeground="#222", font=current_fonts['main'], relief=tk.FLAT, highlightthickness=0, borderwidth=0)
        ...
        self.start_entry = tb.Entry(edit_frame, width=8, font=current_fonts['main'])
        ...
        self.end_entry = tb.Entry(edit_frame, width=8, font=current_fonts['main'])
